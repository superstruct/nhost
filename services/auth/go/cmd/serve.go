	...
	return &cli.Command{ //nolint: exhaustruct
		...
		Flags: []cli.Flag{
			...
			&cli.BoolFlag{ //nolint: exhaustruct
				...
				Usage:    "When enabled, SMS passwordless signin will not auto-create new user accounts. Non-existing phone numbers will receive an identical 200 OK response to prevent enumeration. SMS-scoped alternative to disable-auto-signup.",
				Value:    false,
				Category: "sms",
